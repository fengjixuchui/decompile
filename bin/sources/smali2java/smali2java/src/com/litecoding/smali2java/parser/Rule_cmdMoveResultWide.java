...
final public class Rule_cmdMoveResultWide extends Rule
{
  private Rule_cmdMoveResultWide(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_cmdMoveResultWide parse(ParserContext context)
  {
    ...
    rule = null;
    if (parsed)
      rule = new Rule_cmdMoveResultWide(context.text.substring(s0, context.index), e0);
    else
      context.index = s0;
