...
rem set JAVA_HOME=D:\tools\Java\jdk1.8.0_20\
rem set JAVA_HOME=D:\tools\Java\jdk1.8.0_20
rem set JAVA_HOME=D:\tools\Java\jre\
set JAVA_HOME=D:\tools\Java\jre\
...
rem %JAVA% -Xmx1024m -XX:-UseParallelGC -XX:MinHeapFreeRatio=15 -jar %JEBPATH% %*
