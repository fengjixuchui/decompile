...
.method public a(JJJII[B[BII[J[B[BJJJ[B[B)[B
    ...
    .line 48
    .line 49
    new-instance v6, Loicq/wlogin_sdk/b/h;

    invoke-direct {v6}, Loicq/wlogin_sdk/b/h;-><init>()V

    .line 50
    new-instance v23, Loicq/wlogin_sdk/b/an;

    invoke-direct/range {v23 .. v23}, Loicq/wlogin_sdk/b/an;-><init>()V
    ...
    .line 53
    new-instance v12, Loicq/wlogin_sdk/b/t;

    invoke-direct {v12}, Loicq/wlogin_sdk/b/t;-><init>()V

    .line 54
    new-instance v15, Loicq/wlogin_sdk/b/q;

    invoke-direct {v15}, Loicq/wlogin_sdk/b/q;-><init>()V

    .line 55
    new-instance v14, Loicq/wlogin_sdk/b/al;

    invoke-direct {v14}, Loicq/wlogin_sdk/b/al;-><init>()V

    .line 56
    new-instance v16, Loicq/wlogin_sdk/b/ao;

    invoke-direct/range {v16 .. v16}, Loicq/wlogin_sdk/b/ao;-><init>()V

    .line 57
    new-instance v17, Loicq/wlogin_sdk/b/bc;

    invoke-direct/range {v17 .. v17}, Loicq/wlogin_sdk/b/bc;-><init>()V
    ...
    .line 60
    new-instance v19, Loicq/wlogin_sdk/b/cq;

    invoke-direct/range {v19 .. v19}, Loicq/wlogin_sdk/b/cq;-><init>()V
    ...
    .line 64
    new-instance v26, Loicq/wlogin_sdk/b/af;

    invoke-direct/range {v26 .. v26}, Loicq/wlogin_sdk/b/af;-><init>()V

    .line 65
    new-instance v20, Loicq/wlogin_sdk/b/aq;

    invoke-direct/range {v20 .. v20}, Loicq/wlogin_sdk/b/aq;-><init>()V

    .line 66
    new-instance v27, Loicq/wlogin_sdk/b/ar;

    invoke-direct/range {v27 .. v27}, Loicq/wlogin_sdk/b/ar;-><init>()V

    .line 67
    new-instance v28, Loicq/wlogin_sdk/b/au;

    invoke-direct/range {v28 .. v28}, Loicq/wlogin_sdk/b/au;-><init>()V
    ...
    .line 69
    new-instance v21, Loicq/wlogin_sdk/b/bi;

    invoke-direct/range {v21 .. v21}, Loicq/wlogin_sdk/b/bi;-><init>()V

    .line 70
    new-instance v22, Loicq/wlogin_sdk/b/bl;

    invoke-direct/range {v22 .. v22}, Loicq/wlogin_sdk/b/bl;-><init>()V

    .line 71
    new-instance v30, Loicq/wlogin_sdk/b/bz;

    invoke-direct/range {v30 .. v30}, Loicq/wlogin_sdk/b/bz;-><init>()V

    .line 72
    new-instance v31, Loicq/wlogin_sdk/b/ca;

    invoke-direct/range {v31 .. v31}, Loicq/wlogin_sdk/b/ca;-><init>()V

    .line 73
    new-instance v32, Loicq/wlogin_sdk/b/ce;

    invoke-direct/range {v32 .. v32}, Loicq/wlogin_sdk/b/ce;-><init>()V

    .line 74
    new-instance v33, Loicq/wlogin_sdk/b/ck;

    invoke-direct/range {v33 .. v33}, Loicq/wlogin_sdk/b/ck;-><init>()V
    ...
    invoke-virtual {v6, v0, v7}, Loicq/wlogin_sdk/b/h;->a([BI)V

    .line 77
    invoke-virtual {v6}, Loicq/wlogin_sdk/b/h;->a()[B
    ...
    invoke-virtual {v12, v0, v1, v2}, Loicq/wlogin_sdk/b/t;->a(II[J)[B
    ...
    invoke-virtual {v14, v5}, Loicq/wlogin_sdk/b/al;->a([B)[B
    ...
    iget-object v5, v0, Loicq/wlogin_sdk/request/m;->w:Loicq/wlogin_sdk/request/u;
    ...
    invoke-virtual {v15, v5}, Loicq/wlogin_sdk/b/q;->a([B)[B
    ...
    .line 159
    invoke-virtual/range {v4 .. v13}, Loicq/wlogin_sdk/b/ar;->a([BJJJ[B[B)[B
    ...
    invoke-virtual {v0, v4}, Loicq/wlogin_sdk/b/au;->b(I)[B
    ...
    .line 166
    invoke-virtual/range {v4 .. v12}, Loicq/wlogin_sdk/b/an;->a([B[B[B[B[B[B[B[B)[B
    ...
    iget v4, v0, Loicq/wlogin_sdk/request/m;->t:I

    move-object/from16 v0, p0

    invoke-virtual {v0, v6, v4, v5}, Loicq/wlogin_sdk/request/m;->a([BII)[B
